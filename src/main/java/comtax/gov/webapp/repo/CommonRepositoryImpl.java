...
public class CommonRepositoryImpl implements CommonRepository {
	...
	public UserDet getProfileDetails(String hrms_code) {
	    ...
	    return jdbcTemplate.queryForObject(SELECT_USER_DET, (rs, rowNum) -> {
	        ...
	        user.setEmail(rs.getString("email"));
	        user.setPhoneNo(rs.getString("phoneNo"));
//	        user.setDesigName(rs.getString("desigCd"));
	        user.setGpfNo(rs.getString("gpfNo"));
	        user.setPanNo(rs.getString("panNo"));
	        user.setBoId(rs.getString("boId"));

	        user.setJoiningOrderNo(rs.getString("joiningOrderNo"));
	        user.setBloodGroup(rs.getString("bloodGroup"));
	        user.setHouseNo(rs.getString("houseNo"));
	        user.setPoliceStation(rs.getString("policeStation"));
	        ...
	        String img = rs.getString("profileImageUrl");
	        user.setProfileImageUrl(
	            img != null
	                ? "http://localhost:8082/api/uploads/profile-pics/" + img
	                : null
	        );
	...
	@Override
	public void updateUserProfile(String hrmsCode, UserDet u) {
			
		jdbcTemplate.update(UPDATE_PROFILE_SQL,
	            u.getJoiningOrderNo(),
	            u.getBloodGroup(),
	            u.getEmail(),
	            u.getPhoneNo(),
