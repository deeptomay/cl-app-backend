...
//    @Cacheable(value = "designations", unless = "#result == null || #result.isEmpty()")
	...
	@Override
	@Transactional
	public void updateProfile(String hrmsCode, UserDet userDet) {
		 log.info("Updating profile details for HRMS Code: {}", hrmsCode);

		 commonRepository.updateUserProfile(hrmsCode, userDet);

	        log.info("Profile updated successfully for HRMS Code: {}", hrmsCode);
